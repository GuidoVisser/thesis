...
if __name__ == "__main__":
    ...
    parser.add_argument('--data_dir', default='datasets/DAVIS/Images/dance-jump', help="dataset for evaluation")
    parser.add_argument('--mask_dir', default='datasets/DAVIS/Annotations/dance-jump', help="mask for object removal")
