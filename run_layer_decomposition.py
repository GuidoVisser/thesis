...
if __name__ == "__main__":
    ...
    lambdas.add_argument("--lambda_detail_reg",        nargs="+", default=[100., 50, 0.05], help="lambda of the detail bleed regularization loss")
    lambdas.add_argument("--alpha_bg_scale",           nargs="+", default=[.99], help="downscaling factor for dynamic background in alpha regularization.")
