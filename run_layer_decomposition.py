...
if __name__ == "__main__":
    ...
    lambdas.add_argument("--lambda_mask", nargs="+", default=[10000., 100, 100., 150, 0.], help="values for the lambda of the alpha_mask_bootstrap loss")
    ...
    lambdas.add_argument("--lambda_alpha_l1", nargs="+", default=[0.01, 250, 0.], help="lambda of the l1 part of the alpha regularization loss")
