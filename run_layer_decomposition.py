...
if __name__ == "__main__":
    ...
    lambdas.add_argument("--lambda_mask", nargs="+", default=[10000., 50, 100., 100, 50.], help="values for the lambda of the alpha_mask_bootstrap loss")
    ...
    lambdas.add_argument("--lambda_alpha_l1", nargs="+", default=[0.01, 150, 0.], help="lambda of the l1 part of the alpha regularization loss")
