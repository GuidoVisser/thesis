...
from models.third_party.onion_peel.utils.helpers import *
from models.third_party.onion_peel.models.OPN import OPN
...
for i in range(T):
    ...
    frames[i] = raw_frame
    #### mask
    mask_file = os.path.join(args.mask_dir, '{:05d}.png'.format(i))
...
for f in range(T):
    ...
    est.save(os.path.join(save_path, '{:05d}.jpg'.format(f)))
