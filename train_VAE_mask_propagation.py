...
from models.MaskPropagationVAE import initialize_MaskPropVAE, train_vae, test_vae, demo_model
...
def main(args):
    ...
    # create dataset
    dataset = DAVISPairsDataset(args.data_dir, get_transforms(train=True))
...
if __name__ == '__main__':
    ...
    parser.add_argument("--demo_freq", default=1, type=int,
