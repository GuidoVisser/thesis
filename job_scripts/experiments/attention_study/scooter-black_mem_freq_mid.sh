...
mkdir -p $HOME/thesis/results/layer_decomposition/$VIDEO__$SLURM_JOBID__attention_study__mem_freq_mid
cp -RT $TMPDIR/output_dir $HOME/thesis/results/layer_decomposition/$VIDEO__$SLURM_JOBID__attention_study__mem_freq_mid

read -r t<$TMPDIR/output_dir/time.txt
echo $SLURM_JOBID $VIDEO attention_study__mem_freq_mid $t >> $HOME/thesis/times.txt