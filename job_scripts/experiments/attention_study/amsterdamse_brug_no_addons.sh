...
mkdir -p $HOME/thesis/results/layer_decomposition/${VIDEO}_${SLURM_JOBID}_attention_study__no_addons
cp -RT $TMPDIR/output_dir $HOME/thesis/results/layer_decomposition/${VIDEO}_${SLURM_JOBID}_attention_study__no_addons

read -r t<$TMPDIR/output_dir/time.txt
echo $SLURM_JOBID $VIDEO attention_study__no_addons $t >> $HOME/thesis/times.txt