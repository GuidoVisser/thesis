...
mkdir -p $HOME/thesis/results/layer_decomposition/${VIDEO}_${SLURM_JOBID}_alpha_study__alpha_layers_dyn_composite
cp -RT $TMPDIR/output_dir $HOME/thesis/results/layer_decomposition/${VIDEO}_${SLURM_JOBID}_alpha_study__alpha_layers_dyn_composite

read -r t<$TMPDIR/output_dir/time.txt
echo $SLURM_JOBID $VIDEO alpha_study__alpha_layers_dyn_composite $t >> $HOME/thesis/times.txt