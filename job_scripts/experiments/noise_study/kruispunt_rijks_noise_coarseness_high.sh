...
mkdir -p $HOME/thesis/results/layer_decomposition/$VIDEO_$SLURM_JOBID_noise_study__noise_coarseness_high
cp -RT $TMPDIR/output_dir $HOME/thesis/results/layer_decomposition/$VIDEO_$SLURM_JOBID_noise_study__noise_coarseness_high
