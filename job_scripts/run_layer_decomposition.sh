...
mkdir -p $HOME/thesis/results/layer_decomposition/normal_${VIDEO}_${SLURM_JOBID}
cp -RT $TMPDIR/output_dir $HOME/thesis/results/layer_decomposition/normal_${VIDEO}_${SLURM_JOBID}
