...
python $HOME/thesis/run_layer_decomposition.py \
            ...
            --save_freq 100 \
            --mem_freq 2 \
            --description 'Dynamic model with 2001 epochs and high memory frequency. Includes object masks in the memorizing step, memory backbones have been changed to TopkSTM pretrained encoders'
